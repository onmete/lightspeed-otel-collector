...
require (
	...
	github.com/openshift/lightspeed-otel-collector/agenticdataexporter v0.0.0
...
replace github.com/openshift/lightspeed-otel-collector/agenticdataexporter v0.0.0 => ../../agenticdataexporter
